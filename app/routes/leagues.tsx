...
return [
    ...
    { name: "description", content: "Explore the various leagues within the Florida FIRST Tech Challenge and find information about each league's events, teams, and more." },
];
};
