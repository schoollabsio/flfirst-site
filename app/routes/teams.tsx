...
import { InfoCard, InfoCardAttribute, InfoCardColumn, InfoCardContent, InfoCardHeader } from "~/components/info-card";
...
export default function Teams() {
  ...
  const groupedTeams = teams
    .filter((team) =>
        ...
        team.number.toString().toLowerCase().includes(searchTerm.toLowerCase()) ||
        team.location.city.toLowerCase().includes(searchTerm.toLowerCase()) ||
        team.location.state_province.toLowerCase().includes(searchTerm.toLowerCase())
    )
    .reduce((acc, team) => {
