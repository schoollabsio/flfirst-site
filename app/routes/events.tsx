...
const includesEvent = (searchTerm: string) => (event: Pick<FirstEvent, "name" | "locationName">) => 
      ...
      <div className="w-full">
        {Object.entries(leagueEvents)
          ...
          .map(([leagueCode, events]) => (
            <InfoCategory key={leagueCode} header={leagueCodeToName[leagueCode]}>
              {events
              .filter(includesEvent(searchTerm))
              .map((event) => (
