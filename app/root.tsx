    ...
    <html lang="en">
      ...
      <body className="bg-gray-100 flex flex-col min-h-screen pt-16 pb-20 bg-cover bg-fixed">
        ...
        <div className="flex items-center justify-center pt-5 px-5 text-black">
          ...
          <div
            className="w-full flex justify-center items-center py-4 px-6 fixed bottom-0 bg-white drop-shadow-[0_35px_35px_rgba(0,0,0,0.25)]"
            >
            <div className="flex-1"></div>
            <div className="flex-1">
              <a className="block w-full text-center" href="https://visitcentralflorida.org/" target="_blank">
                <img
