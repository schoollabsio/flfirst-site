import{j as e}from"./jsx-runtime-d4vcKfGz.js";import{M as n}from"./markdown-pxkRYKB4.js";const a=`# Introducing the all new Florida First Tech Challenge website!
...
_– Hans Wolf_
`,u=()=>[{title:"Newsletter | Florida FIRST Tech Challenge"},{name:"description",content:"Welcome to Remix!"}],h=({children:o})=>e.jsx("div",{className:"bg-white shadow-md p-4",children:e.jsx("div",{className:"flex flex-col gap-4",children:o})}),t=({content:o})=>e.jsx(h,{children:e.jsx(n,{markdown:o})});function m(){return e.jsxs("div",{className:"flex flex-col max-w-prose mx-auto gap-4",children:[e.jsx(t,{content:l}),e.jsx(t,{content:r}),e.jsx(t,{content:s}),e.jsx(t,{content:i}),e.jsx(t,{content:a})]})}export{m as default,u as meta};
